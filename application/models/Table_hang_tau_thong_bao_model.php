...
class Table_hang_tau_thong_bao_model extends Crud_model {

    private $table = null;

    function __construct() {
        $this->table = 'hang_tau_gui_thong_bao_nhap_sea';
        parent::__construct($this->table);
    }

    function get_details($options = array()) {
        $table = $this->db->dbprefix('hang_tau_gui_thong_bao_nhap_sea');
        $where = "";
