<div style=" margin: auto;">
    ...
    if ($style === "style_2") {
        $this->load->view('estimates/estimate_parts/header_style_2_pdf.php', $data);
    } else {
        $this->load->view('estimates/estimate_parts/header_style_1_pdf.php', $data);
    }
    ?>
</div>
...
<table style="width: 100%; color: #444;">            
    ...
    <?php } ?>
    <tr>
        <td colspan="3" style="text-align: right;"><span>Fob Charges Total</span>  </td>
        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
            <?php echo to_currency($estimate_total_summary->sub_price, $estimate_total_summary->currency_symbol); ?>
        </td>
    </tr>
    <tr>
