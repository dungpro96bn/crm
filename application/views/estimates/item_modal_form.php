...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="estimate_item_rate" class=" col-md-3">A/L</label>
        <div class="col-md-9">
            <select class="select2-choice" style="width: 100%;height: 34px;text-transform: uppercase;" name="price_id">
            <?php
            foreach ($price as $option){ ;?>
                <option <?php if ($model_info->rate_id == $option->id ) echo 'selected' ; ?> value="<?php echo $option->id ;?>"><?php echo $option->a_l ;?></option>
            <?php };?>
            </select>
        </div>
    </div>
