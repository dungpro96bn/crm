            ...
            <div class="col-md-3"><!-- style button type -->
                ...
                <div class="select2-container w125" style="position:absolute;z-index: 999; margin-left: 45px;">
                    <select onchange="location = this.value;" class="select2-choice w125" >
                        <option value='<?php echo_uri('projects/all_tasks_kanban/'); ?>'>Types</option>
                        <option value='<?php echo_uri('projects/air_kanban/'); ?>'>Xuất Air</option>
                        <option selected value='<?php echo_uri('projects/nhap_air_kanban/'); ?>'>Nhập Air</option>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#kanban-filters").appFilters({
            source: '<?php echo_uri("projects/nhap_air_kanban_data") ?>',
