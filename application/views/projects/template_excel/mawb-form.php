<?php echo form_open_multipart(get_uri("huongdan_guihang/save"), array("id" => "pdf-form", "class" => "general-form", "role" => "form",)); ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="col-md-12 b-t pt10 list-container">
  ...
  <table width="100%">
    <tr style="line-height: 25px; font-size: 14px">
      ...
      <td width="63%">
        <input type="text" name="code3" onKeyUp="limitText(this.form.code3,this.form.countdown,5);" value="<?php echo @$info['0']->code3;?>" class="form-control" placeholder="8009 2334" style="width: 15%">
      </td>
      <td width="21%">
  ...
  <table width="100%" border="1">
    <tr>
      ...
      <td width="25%">
        ...
        <input type="text" name="shipper" onKeyUp="limitText(this.form.shipper,this.form.countdown,20);" value="<?php echo @$info['0']->shipper;?>"   class="form-control" style="width: 80%">
      </td>
      <td rowspan="2" width="14%" style="border-right-color: white; border-left-color: black">
        <span>NOT NEGOTIABLE</span><br><br><br>
        <span style="font-weight: bold;font-size: 16px">Air Waybill</span><br><br>
        <span>Issued by</span>
      </td>
      <td width="36%" rowspan="2" style="border-left-color: white">
          <?php echo @$error;?>
          <input type="file" name="userfile" size="20"  />"<?php echo @$info['0']->logo_img;?>"
          <input value="<?php echo @$info['0']->logo_img;?>" name="url_img" hidden="hidden">
          <input type="text" name="name" class="form-control" onKeyUp="limitText(this.form.name,this.form.countdown,21);" style="text-transform: uppercase;" value="<?php echo @$info['0']->name;?>" >

      </td>
    </tr>
    <tr>
      <td height="80px" colspan="2" style="border-top-color: white">
        <textarea name="shipper_number" onKeyUp="limitText(this.form.shipper_number,this.form.countdown,300);"  class="form-control" rows="3" style="width: 80%; text-transform: uppercase;"><?php echo @$info['0']->shipper_number;?></textarea>
      </td>
    </tr>
  </table>
  ...
  <table width="100%" border="1">
    <tr>
      ...
      <td width="25%">
        ...
        <input type="text" name="consignee" onKeyUp="limitText(this.form.consignee,this.form.countdown,20);" value="<?php echo @$info['0']->consignee;?>" class="form-control" style="width: 80%">
      </td>
    ...
    <tr>
      <td colspan="2" style="border-top-color: white">
        <textarea name="consignee_number" rows="6" onKeyUp="limitText(this.form.consignee_number,this.form.countdown,300);" class="form-control" style="width: 80%; text-transform: uppercase;"><?php echo @$info['0']->consignee_number;?></textarea>
      </td>
      <td height="145px" width="50%" style="text-align: left; line-height: 1.5rem; padding: 10px">
          <span>It is agreed that the goods described herein are accepted on apparent good order and condition ( excepted as noted ) for carriage</span> <span style="font-size: 12px;">SUBJECT TO THE CONDITIONS OF CONTRACT ON THE REVERSE HEREOF. ALL GOODS MAY BE CARRIED BY ANY  OTHER MEANS INCLUDING ROAD OR ANY OTHER CARRIER UNLESS SPECIFIC CONTRARY INSTRUCTIONS ARE GIVEN HEREON BY THE SHIPPER, AND SHIPPER AGREES THAT THE SHIPMENT MAY BE CARRIED VIA INTERMEDIATE STOPPING PLACE WHICH THE CARRIER DEEMS APPROPRIATES. THE SHIPPER'S ATTENTION IS DRAWN TO THE NOTICE CONCERNING CARRIER'S LIMITATION OF  LIABILITY.</span><span> Shipper may increase such limitation of liability by declaring a higher value for carriage and paying a supplemental charge if required.</span>
      </td>
    </tr>
  </table>
  ...
  <table width="100%" border="1">
    <tr>
      <td width="50%" colspan="2">
        ...
        <b style="font-size: 
        16px; text-align: center;"><?php echo @$info['0']->name;?></b>
      </td>
  ...
  <table width="100%" border="1">
    ...
    <tr style="text-align: center;">
      ...
      <td style="line-height: 30px">
        <input type="text" name="currency" onKeyUp="limitText(this.form.currency,this.form.countdown,5);" value="<?php echo @$info['0']->currency;?>" class="form-control" style="width: 90%; text-transform: uppercase;text-align: center;" placeholder="USD">
      </td>
      <td style="line-height: 30px">
      ...
      <td style="font-size: 12px" width="5%">
        <span>PPD</span><br>
        <input type="radio" class="radio" name="wt_val" value="P" <?php echo (@$info['0']->wt_val=='P')?'checked':'' ?>  checked="checked">
      </td>
      ...
      <td style="font-size: 12px" width="5%">
        <span>PPD</span><br>
        <input type="radio" class="radio" name="other" value="P" checked="checked" <?php echo (@$info['0']->other=='P')?'checked':'' ?> >
      </td>
      <td style="font-size: 12px">
        <span>COLL</span><br>
        <input type="radio" class="radio" name="other" value="C" <?php echo (@$info['0']->other=='C')?'checked':'' ?> >
      </td>
      <td style="line-height: 30px">
  ...
  <table width="100%" border="1">
    ...
    <tr style="text-align: center; line-height: 27px">
      <td>
        <input type="text" name="airport_of_destination" onKeyUp="limitText(this.form.airport_of_destination,this.form.countdown,24);" value="<?php echo @$info['0']->airport_of_destination;?>" class="form-control" style="width: 90%; text-transform: uppercase;text-align: center;font-weight: bold;" placeholder="MXP AIRPORT, ITALY">
      </td>
      <td>
        <input type="text" name="requested_flight_date" onKeyUp="limitText(this.form.requested_flight_date,this.form.countdown,24);" value="<?php echo @$info['0']->requested_flight_date;?>" class="form-control" style="width: 90%; text-transform: uppercase;text-align: center; font-weight: bold;" placeholder="EY972/14APR18">
      </td>
      <td>
        <input type="text" name="amount_of_insurance" onKeyUp="limitText(this.form.amount_of_insurance,this.form.countdown,24);" value="<?php echo @$info['0']->amount_of_insurance;?>" class="form-control" style="width: 90%; text-transform: uppercase;text-align: center; font-weight: bold;">
      </td>
    </tr>
  </table>
  ...
  <table width="100%" border="1">
    ...
    <tr>
      ...
      <td rowspan="4">
        ...
        <textarea name="quantity_of_goods" rows="3" class="form-control" onKeyUp="limitText(this.form.quantity_of_goods,this.form.countdown,100);" style="width: 95%"><?php echo @$info['0']->quantity_of_goods;?></textarea>
        ...
        <span>Vol.:</span>
        <input type="text" name="vol" onKeyUp="limitText(this.form.vol,this.form.countdown,40);" value="<?php echo @$info['0']->vol;?>" class="form-control" style="width: 95%">
      </td>
    </tr>
    <tr>
      <td colspan="6" style="padding-top: 10px; padding-bottom: 10px">
        <div class="form-group">
          <label for="title" class="col-md-3 col-sm-3">SAP NO _ _ _</label>
        ...
        <div class="form-group">
          <label for="title" class="col-md-3 col-sm-3">MARK _ _ _</label>
          <div class=" col-md-9 col-sm-9">
        ...
        <div class="form-group">
          <label for="title" class="col-md-3 col-sm-3">CIQ NO _ _ _</label>
          <div class=" col-md-9 col-sm-9">
              <input type="text" name="ciq_no" onKeyUp="limitText(this.form.ciq_no,this.form.countdown,55);" value="<?php echo @$info['0']->ciq_no;?>" id="title" class="form-control">
          </div>
        </div>
        <div class="form-group">
          <label for="title" class="col-md-3 col-sm-3">CODE _ _ _</label>
          <div class=" col-md-9 col-sm-9">
              <input type="text" name="code" onKeyUp="limitText(this.form.code,this.form.countdown,55);" value="<?php echo @$info['0']->code;?>" id="title" class="form-control">
          </div>
        </div>
        <div class="form-group">
          <label for="title" class="col-md-3 col-sm-3">QTY _ _ _</label>
          <div class=" col-md-9 col-sm-9">
              <input type="text" name="qty" onKeyUp="limitText(this.form.qty,this.form.countdown,55);" value="<?php echo @$info['0']->qty;?>" id="title" class="form-control">
          </div>
        </div>
      </td>
    </tr>
    <tr>
      <td width="53%" colspan="6" style="line-height: 20px; padding-top: 5px; padding-bottom: 5px">
        <div class="form-group" style="margin-bottom: 0px">
          <label for="title" class="col-md-2" style="padding-top: 5px; ">Total</label>
          <div class=" col-md-10">
              <input type="text" name="total_all" onKeyUp="limitText(this.form.total_all,this.form.countdown,75);" value="<?php echo @$info['0']->total_all;?>"  class="form-control">
          </div>
        </div>
      </td>
    </tr>
  ...
  <table width="100%" border="1" >
    ...
    <tr style="text-align: center;">
      <td height="30px" width="20%" >
        <input type="radio" class="radio" value="P" name="weight_charge" <?php echo (@$info['0']->weight_charge=='P')?'checked':'' ?> >
      </td>
      <td width="20%" >
        <input type="radio" class="radio" value="C" name="weight_charge" <?php echo (@$info['0']->weight_charge=='C')?'checked':'' ?> >
      </td>
    </tr>
    <tr style="text-align: center;">
    ...
    <tr style="text-align: center;">
      <td height="30px" width="20%">
        <input type="radio" class="radio" value="P" name="valuation_charge" <?php echo (@$info['0']->valuation_charge=='P')?'checked':'' ?> >
      </td>
      <td width="20%">
        <input type="radio" class="radio" value="C" name="valuation_charge" <?php echo (@$info['0']->valuation_charge=='C')?'checked':'' ?> >
      </td>
    </tr>
    <tr>
      <td height="30px" colspan="2" style="text-align: center;">
    ...
    <tr style="text-align: center;">
      <td height="30px" width="20%">
        <input type="radio" class="radio" value="P" name="tax" <?php echo (@$info['0']->tax=='P')?'checked':'' ?> >
      </td>
      <td width="20%">
        <input type="radio" class="radio" value="C" name="tax" <?php echo (@$info['0']->tax=='C')?'checked':'' ?> >
      </td>
    </tr>
  </table>
  ...
  <table width="100%" border="1" style="text-align: center;">
    ...
    <tr>
      <td height="30px" width="20%">
        <input type="radio" class="radio" value="P" name="total_other_agent" <?php echo (@$info['0']->total_other_agent=='P')?'checked':'' ?> >
      </td>
      <td width="20%">
        <input type="radio" class="radio" value="C" name="total_other_agent" <?php echo (@$info['0']->total_other_agent=='C')?'checked':'' ?> >
      </td>
    </tr>
    <tr>
      <td height="30px" colspan="2" style="text-align: center;">
    ...
    <tr>
      <td height="30px" width="20%">
        <input type="radio" class="radio" value="P" name="total_other_carrier" <?php echo (@$info['0']->total_other_carrier=='P')?'checked':'' ?> >
      </td>
      <td width="20%">
        <input type="radio" class="radio" value="C" name="total_other_carrier" <?php echo (@$info['0']->total_other_carrier=='C')?'checked':'' ?> >
      </td>
    </tr>    
  </table>
  ...
  <table width="100%" border="1" style="margin-bottom: 20px">
    ...
    <tr>
      <td height="30px" width="20%" style="text-align: center;">
        <input type="radio" class="radio" value="P" name="total_prepaid_collect" <?php echo (@$info['0']->total_prepaid_collect=='P')?'checked':'' ?> >
      </td>
      <td width="20%" style="text-align: center;">
       <input type="radio" class="radio" value="C" name="total_prepaid_collect" <?php echo (@$info['0']->total_prepaid_collect=='C')?'checked':'' ?> >
      </td>
    </tr>
    <tr>
      <td width="20%" >
    ...
    <tr style="text-align: center;">
      <td height="30px" width="20%">
        <input type="radio" class="radio" value="P" class="radio" name="conversion_rates" <?php echo (@$info['0']->conversion_rates=='P')?'checked':'' ?> >
      </td>
      <td width="20%">
        <input type="radio" class="radio" value="C" class="radio" name="conversion_rates" <?php echo (@$info['0']->conversion_rates=='C')?'checked':'' ?> >
      </td>
    </tr>
    <tr>
      <td  width="20%" style="text-align: center; ">
    ...
    <tr style="text-align: center;">
      <td height="30px" width="20%">
        <input type="radio" class="radio" value="P" name="charges_at_destination" <?php echo (@$info['0']->charges_at_destination=='P')?'checked':'' ?> >
      </td>
      <td width="20%">
        <input type="radio" class="radio" value="C"  name="charges_at_destination" <?php echo (@$info['0']->charges_at_destination=='C')?'checked':'' ?> >
      </td>
    </tr>
  </table>
