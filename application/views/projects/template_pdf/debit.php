...
<div class="container">
  ...
  <table width="100%" border="">
    <tr>
      <td width="45%" height="120px">
        ...
        <span>No:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight: bold;"><?php echo @$info1['0']->no_add;?></span><br><br>
        <span>Date:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><?php echo @$info1['0']->date;?></span>
      </td>
      <td width="55%"><span style="font-size: 18px; font-weight: bold;">Messrs:</span><br><br><span style="text-transform: uppercase;line-height: 30px"><?php echo @$info1['0']->messrs_add;?></span>
      </td>
 ...
 <table width="100%" border="1" style="margin-top: 80px; font-family: 'time new roman';">
      ...
      <tr>
        <td></td>
        <td height="100px" style="padding: 10px"><span style="line-height: 20px"><?php echo @$info1['0']->description;?></span>
        </td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr style=" line-height: 30px">
        ...
        <td style="text-align: center;"><span><?php echo @$info1['0']->air_freight_volume;?></span>
        </td>
        <td style="padding: 5px 10px; ">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->air_freight_rate;?></span>
        </td>
        <td style="padding: 5px 10px; ">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->air_freight_amount;?></span>
        </td>
      </tr>
      <tr style=" line-height: 30px" >
        <td height="30px" style="text-align: center; ">
        ...
        <td></td>
        <td style="padding: 5px 10px; ">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->x_ray_rate;?></span>
        </td>
        <td style="padding: 5px 10px; ">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->x_ray_amount;?></span>
        </td>
      </tr>
      <tr style=" line-height: 30px">
        <td height="30px" style="text-align: center;">
        ...
        <td></td>
        <td style="padding: 5px 10px">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->cgc_amount;?></span>
        </td>
      </tr>
      <tr style=" line-height: 30px">
        <td height="30px" style="text-align: center; ">
        ...
        <td></td>
        <td style="padding: 5px 10px">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->mawb_amount;?></span>
        </td>
      </tr>
      <tr style=" line-height: 30px">
        <td height="30px" style="text-align: center;">
        ...
        <td></td>
        <td style="padding: 5px 10px">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->profit_rate;?></span>
        </td>
        <td style="padding: 5px 10px">
          <span>$</span>&nbsp;<span><?php echo @$info1['0']->profit_amount;?></span>
        </td>
      </tr>
      <tr>
        <td height="30px"></td>
      ...
      <tr>
        ...
        <td style="font-weight: bold;line-height: 30px; font-size: 13px">
          <span>$ <?php echo @$info1['0']->total_galaxy;?></span>
        </td>
      </tr>
      <tr>
        <td height="30px" colspan="5" style="line-height: 30px">
          <span style="font-size: 14px">In words:</span>&nbsp;&nbsp;<span>US dollars <?php echo @$info1['0']->in_words_total;?>.</span>
        </td>
      </tr>
    </table>
