...
<!--    <li role="presentation" class="--><?php //echo ($active_tab == 'form_email_template') ? 'active' : ''; ?><!--"><a href="--><?php //echo_uri("settings/form_email_template"); ?><!--">--><?php //echo lang("form_email_template"); ?><!--</a></li>-->
<!--    --><?php //} ?>
