...
<div id="page-content" class="clearfix">
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        ...
        <?php } ?>
        <?php if ($show_sender_mail) { ?>
        <li><a role="presentation" href="<?php echo_uri("team_members/sender_address/" . $user_info->id); ?>" data-target="#tab-sender-address"> <?php echo lang('email_settings'); ?></a></li>
        <?php } ?>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-sender-address"></div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        } else if (tab === "sender_address") {
            $("[data-target=#tab-sender-address]").trigger("click");
        }
